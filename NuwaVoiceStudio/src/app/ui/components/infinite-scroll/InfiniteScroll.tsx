...
export default class InfiniteScroll extends Component<Props, State> {
  ...
  render() {
    ...
    return (
      <div
        style={outerDivStyle}
        className="w-full infinite-scroll-component__outerdiv"
      >
        <div
          className={`infinite-scroll-component ${this.props.className || ''}`}
          ref={(infScroll: HTMLDivElement) => (this._infScroll = infScroll) as any}
          style={style}
        >
          {this.props.pullDownToRefresh && (
            <div
              style={{ position: 'relative' }}
              ref={(pullDown: HTMLDivElement) => (this._pullDown = pullDown) as any}
            >
              <div
                style={{
                  position: 'absolute',
